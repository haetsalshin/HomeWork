	...
	public boolean play() {
		...
		for(int i = 0; i <10 ; i ++) {
			...
			if(i == 0) {
				...
				if((10- intScore1) - rnd.nextInt((10)+1) < 0) {
					continue;
					
				} else if(intScore1 == 10){
					System.out.printf(" \n");
					
				}else {
					int intScore2 = (10 - intScore1) - rnd.nextInt((10)+1);
				...
				if(gameList.get(i-1).getScore1() == 10) {
					...
					int intScore2 = (10 - intScore1) - (rnd.nextInt((10)+1)+strike);
